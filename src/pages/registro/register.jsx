...
function Register() {
  ...
  return (
    <div className="min-h-screen w-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="bg-white shadow-xl rounded-2xl overflow-hidden flex flex-col md:flex-row w-full max-w-5xl min-h-[600px]">
        
        {/* COLUMNA IZQUIERDA: Formulario */}
        <div className="w-full md:w-1/2 p-8 lg:p-12 flex flex-col justify-center">
          <div className="mb-6">
            <h1 className="text-3xl font-bold text-slate-800">Crear cuenta</h1>
            <p className="text-slate-500 mt-2">Regístrate como cliente para solicitar tus fletes.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-slate-200 rounded-xl outline-none focus:ring-2 focus:ring-blue-600"
            ...
            <button
              ...
              className="w-full bg-blue-600 text-black py-3.5 rounded-xl font-semibold hover:bg-blue-700 transition-colors disabled:opacity-50"
            >
          ...
          <div className="mt-8">
            <div className="relative flex items-center justify-center mb-6">
              ...
              <span className="absolute bg-white px-4 text-xs text-slate-400 uppercase tracking-wider">O regístrate con</span>
            </div>
        ...
        <div className="hidden md:flex md:w-1/2 bg-blue-600 p-12 text-white flex-col justify-center">
          <div className="max-w-md">
            <h2 className="text-4xl font-bold mb-6 leading-tight">Únete a la red de logística.</h2>
            <div className="space-y-4">
              <p className="flex items-center gap-3 text-blue-100"><span className="h-2 w-2 bg-blue-300 rounded-full"></span> Acceso a los mejores transportistas.</p>
              <p className="flex items-center gap-3 text-blue-100"><span className="h-2 w-2 bg-blue-300 rounded-full"></span> Seguridad en cada traslado.</p>
              <p className="flex items-center gap-3 text-blue-100"><span className="h-2 w-2 bg-blue-300 rounded-full"></span> Soporte personalizado.</p>
            </div>
          </div>
        </div>
